...
const DetailsSection = () => {
    ...
    return(
        <div className="flex flex-col md:p-15 gap-4">
            <h1 className="text-3xl font-bold font-headers text-center mb-3">Add Hotel</h1>
         ...
         <label className="text-gray-800 font-bold text-sm max-w-[50%]">
           Price Per Night
            <input 
            type="number"
            min={1} 
